...
def get_num_class_pretraindata():
    x = np.load(f".\dataset\ADSB\PreTrain\X_train_90Class.npy")
    y = np.load(f".\dataset\ADSB\PreTrain\Y_train_90Class.npy")
    x = x.transpose(0, 2, 1)
    train_index_shot = []
    for i in range(90):
...
def get_num_class_finetunedata(k):
    x = np.load(f".\dataset\ADSB\Train\X_train_10Class.npy")
    y = np.load(f".\dataset\ADSB\Train\Y_train_10Class.npy")
    x = x.transpose(0, 2, 1)
    x_test = np.load(f".\dataset\ADSB\Test\X_test_10Class.npy")
    y_test = np.load(f".\dataset\ADSB\Test\Y_test_10Class.npy")
